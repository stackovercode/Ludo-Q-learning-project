...
axs.set_xlabel('Number of games', fontsize=14)
axs.set_ylabel('Win rate [%]', fontsize=14)
plt.xticks(fontsize=11)
plt.yticks(fontsize=11)
axs.legend(loc=4, fontsize=14)
axs.set_title('Learning Rate', fontsize=14)
...
plt.yticks(fontsize=11)
axs.legend(loc=4, fontsize=14)
axs.set_title('Discount Factor', fontsize=14)
...
plt.yticks(fontsize=11)
axs.legend(loc=4, fontsize=14)
axs.set_title('Boltzmann Temperature', fontsize=14)
